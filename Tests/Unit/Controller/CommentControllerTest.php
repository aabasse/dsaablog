...
/**
 * Test case for class Dawin2015\Dsaablog\Controller\CommentController.
 *
...
class CommentControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \Dawin2015\Dsaablog\Controller\CommentController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('Dawin2015\\Dsaablog\\Controller\\CommentController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
