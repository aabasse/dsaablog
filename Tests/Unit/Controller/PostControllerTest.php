...
/**
 * Test case for class Dawin2015\Dsaablog\Controller\PostController.
 *
...
class PostControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \Dawin2015\Dsaablog\Controller\PostController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('Dawin2015\\Dsaablog\\Controller\\PostController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	{
		$post = new \Dawin2015\Dsaablog\Domain\Model\Post();
